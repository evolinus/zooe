  (function(){
    ...
    function renderLineage(lineage){
      ...
      // how big the card ends up being or how many lineages are on screen. Skips
      // drawing entirely if the tab is hidden (rendered width 0) instead of
      // falling back to a guessed size — a fallback would stick as this canvas's
      // permanent inline width, since every later measurement just reads it back.
      // The window 'resize' listener below re-renders once the tab is visible.
