    ...
    const SHAPES = {
      ...
      fish: {
        ...
        ancestor(){
          return {
            bodyHue: 200, finHue: 24, tailHue: 24, strokeW: 3,
        ...
        draw(ctx, genome){
          const g = genome;
          const bodyColor = `hsl(${g.bodyHue.toFixed(1)}, 55%, 27%)`;
          const finColor  = `hsl(${g.finHue.toFixed(1)}, 60%, 45%)`;
          ...
          const noseX = -g.bRxFront, tailBaseX = g.bRxBack;
          const centerX = (noseX + tailBaseX) / 2;
